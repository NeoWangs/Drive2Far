---
layout: post
title: "浅析圆形物体的碰撞检测及应用"
date: "2011-03-16 10:59:41 +0800"
slug: "浅析圆形物体的碰撞检测及应用"
category: "developer"
categories:
  - "developer"
tags:
  - "Math"
permalink: "/2011/03/16/浅析圆形物体的碰撞检测及应用/"
---
...
<div class="runcode"><textarea class="runcode_text" id="runcode_20110316___1">&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
&lt;meta charset='UTF-8' /&gt;
&lt;title&gt;圆形物体碰撞检测&lt;/title&gt;
&lt;meta name="author" content="Benjamin Joffe" /&gt;
&lt;style type="text/css"&gt;
#balls { border: 1px solid #000;box-shadow: 0 1px 5px #777;-moz-box-shadow: 0 1px 5px #777;-webkit-box-shadow: 0 1px 5px #777;}
&lt;/style&gt;
&lt;/head&gt;
&lt;body&gt;
&lt;canvas id="balls" width="800" height="800"&gt;请使用非ie浏览器，当然ie9也行&lt;/canvas&gt;
&lt;/body&gt;
...
// 中文注释:ONEBOYS &gt;&gt; http://www.cssass.com
    ...
    draw();
&lt;/script&gt;
&lt;/html&gt;</textarea><div class="runcode_actions"><button type="button" class="runcode_button" onclick="runcode.open('runcode_20110316___1')">Run</button><button type="button" class="runcode_button" onclick="runcode.copy('runcode_20110316___1')">Copy</button></div></div>
