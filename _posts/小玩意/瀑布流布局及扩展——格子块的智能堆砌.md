---
layout: post
title: "瀑布流布局及扩展——格子块的智能堆砌"
date: "2011-10-12 11:16:33 +0800"
slug: "瀑布流布局及扩展——格子块的智能堆砌"
category: "developer"
categories:
  - "developer"
tags:
permalink: "/2011/10/12/瀑布流布局及扩展——格子块的智能堆砌/"
---
...
部分代码：
 <div class="runcode"><textarea class="runcode_text" id="runcode_20111012___1">&lt;!doctype html&gt;
&lt;html&gt;
&lt;head&gt;
&lt;meta charset="UTF-8" /&gt;
&lt;title&gt;等宽格子堆砌&lt;/title&gt;
...
&lt;/script&gt;
&lt;/html&gt;</textarea><div class="runcode_actions"><button type="button" class="runcode_button" onclick="runcode.open('runcode_20111012___1')">Run</button><button type="button" class="runcode_button" onclick="runcode.copy('runcode_20111012___1')">Copy</button></div></div>

这种布局中虽然每个Pin的高度不尽相同，但是他们的宽度都是一样的。
那么假如，很邪恶的提出一个要求，宽度也不尽相同，只是说宽高都按比例成倍增加，那还怎么排列呢？
呵呵，如下：

 <div class="runcode"><textarea class="runcode_text" id="runcode_20111012___2">&lt;!doctype html&gt;
&lt;html&gt;
&lt;head&gt;
&lt;meta charset="UTF-8" /&gt;
...
&lt;/script&gt;
&lt;/body&gt;
&lt;/html&gt;</textarea><div class="runcode_actions"><button type="button" class="runcode_button" onclick="runcode.open('runcode_20111012___2')">Run</button><button type="button" class="runcode_button" onclick="runcode.copy('runcode_20111012___2')">Copy</button></div></div>

现在这种布局已经不能叫瀑布流了，我们称之为格子块，格子块通过算法智能堆砌。

支持一下拖动交换：
 <div class="runcode"><textarea class="runcode_text" id="runcode_20111012___3">&lt;!doctype html&gt;
&lt;html&gt;
&lt;head&gt;
&lt;meta charset="UTF-8" /&gt;
...
&lt;/script&gt;
&lt;/body&gt;
&lt;/html&gt;</textarea><div class="runcode_actions"><button type="button" class="runcode_button" onclick="runcode.open('runcode_20111012___3')">Run</button><button type="button" class="runcode_button" onclick="runcode.copy('runcode_20111012___3')">Copy</button></div></div>
