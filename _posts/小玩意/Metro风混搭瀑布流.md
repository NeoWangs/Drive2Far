...
<div class="runcode"><textarea class="runcode_text" id="runcode_20121209_Metro__1">&lt;!doctype html&gt;
&lt;html&gt;
&lt;head&gt;
&lt;meta charset="UTF-8" /&gt;
...
&lt;/script&gt;
&lt;/body&gt;
&lt;/html&gt;</textarea><div class="runcode_actions"><button type="button" class="runcode_button" onclick="runcode.open('runcode_20121209_Metro__1')">Run</button><button type="button" class="runcode_button" onclick="runcode.copy('runcode_20121209_Metro__1')">Copy</button></div></div>

应大家要求，我将主要的sort方法取出来，再做个简单demo

<div class="runcode"><textarea class="runcode_text" id="runcode_20121209_Metro__2">&lt;!doctype html&gt;
&lt;html&gt;
&lt;head&gt;
&lt;meta charset="UTF-8" /&gt;
&lt;title&gt;CSSASS&lt;/title&gt;
...
&lt;/script&gt;
&lt;/html&gt;</textarea><div class="runcode_actions"><button type="button" class="runcode_button" onclick="runcode.open('runcode_20121209_Metro__2')">Run</button><button type="button" class="runcode_button" onclick="runcode.copy('runcode_20121209_Metro__2')">Copy</button></div></div>
